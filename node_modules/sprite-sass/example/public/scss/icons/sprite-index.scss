$arrow-down.png: 0px 50px 10px 7px;

$arrow-right.png: 60px 50px 5px 8.5px;

$arrow-up.png: 115px 50px 10px 7px;

$clock.png: 175px 50px 9px 9px;

$spriteImage: url(../../img/icons/sprite-index.png);
